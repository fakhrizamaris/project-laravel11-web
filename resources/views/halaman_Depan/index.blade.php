...
<body id="page-top">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg bg-transparent text-uppercase fixed-top" id="mainNav">
        <div class="container">
            {{-- <a class="navbar-brand" href="#page-top">Start Bootstrap</a> --}}
            <div class="logo-lldikti">
                <div class="overlay"></div>
                <img class="w-25" src="{{ asset('halaman_dashboard/img/Logo_lldikti1.png') }}" alt="logo_lldikti1">
            </div>
    ...
    <header class="masthead bg-transparent text-white text-center">
        ...
        {{-- <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="{{ asset('halaman_depan/assets/img/avataaars.svg') }}"
            alt="..." />
            <!-- Masthead Heading-->
    ...
    <section class="bg-hero-normal">
        <img class="bg-img-normal"
            src="https://sinergidikti.kemdikbud.go.id/application/themes/sinergi-fe/assets/img/background-peraturan.jpg"
            alt="Background Image" style="color: rgba(0, 0, 0, 0.5);">
        <div class="bg-layer-normal"></div>
    </section>
    <!-- Portfolio Section-->
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Copyright &copy; Fakhri Website 2024</small></div>
    </div>
    <!-- Portfolio Modals-->
    <!-- Portfolio Modal 1-->
